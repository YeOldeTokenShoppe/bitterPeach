...
const BookAnimation = () => {
  ...
  const PAGES = 10;
  const shuffledDemos = [...DEMOS].sort(() => 0.5 - Math.random());
  ...
  useEffect(() => {
    ...
    gsap.to(bookRef.current, {
      ...
      scale: 1.5, // Changed from 1 to 1.5 for larger final size
    });
  ...
  const renderSketch = (idx) => {
    const demo = shuffledDemos[idx - 1];
    if (!demo) return null;
    
    return (
      <a href={`https://codepen.io/jh3y/full/${demo.id}`} target="_blank" rel="noreferrer noopener">
        <img src={`https://s3-us-west-2.amazonaws.com/s.cdpn.io/605876/${demo.name || 'Book'}-sketch.svg`} alt={demo.name} />
      </a>
    );
  };
  ...
  return (
    <>
      ...
      <div className="book" ref={bookRef}>
        ...
        <div className="page book__page book__cover book__cover--front" style={{'--page-index': 1}} ref={el => pagesRef.current[0] = el}>
        ...
        {[...Array(PAGES)].map((_, p) => (
          <div key={p} className="page book__page" style={{'--page-index': p + 2}} ref={el => pagesRef.current[p + 1] = el}>
            <div className="page__half page__half--front">
              {renderSketch(p * 2 + 1)}
        ...
        <div className="page book__page book__cover book__cover--back" style={{'--page-index': PAGES + 2}} ref={el => pagesRef.current[PAGES + 1] = el}>
          ...
          <div className="book__insert">
            <a href="https://jhey.dev" target="_blank" rel="noopener noreferrer">
              <img className="logo" ref={logoRef} src="https://assets.codepen.io/605876/bear-with-cap.svg" alt="Logo" />
            </a>
          </div>
        </div>
      </div>
...
//   // CUSTOMIZE YOUR SKETCHES HERE!
//   // Option 1: Use local images (recommended)
//   const DEMOS = [
//     { name: 'MySketch1', src: '/images/sketch1.jpg', link: 'https://myportfolio.com/project1' },
//     { name: 'MySketch2', src: '/images/sketch2.jpg', link: 'https://myportfolio.com/project2' },
//     { name: 'MySketch3', src: '/images/sketch3.jpg', link: 'https://github.com/myusername/project3' },
//     { name: 'MySketch4', src: '/images/sketch4.jpg', link: 'https://mywebsite.com' },
//     { name: 'MySketch5', src: '/images/sketch5.jpg', link: '#' }, // Use # for no link
//     { name: 'MySketch6', src: '/images/sketch6.jpg', link: 'https://example.com' },
//     // Add more sketches as needed...
//   ];

//   // Option 2: Keep using CodePen format (if you have CodePen projects)
//   // const DEMOS = [
//   //   { name: 'YourProjectName', id: 'YourCodePenID' },
//   //   { name: 'AnotherProject', id: 'AnotherCodePenID' },
//   // ];

//   // Adjust this based on how many sketches you have
//   // Each page shows 2 sketches (front and back), so:
//   // PAGES = Math.ceil(DEMOS.length / 2)
//   const PAGES = Math.ceil(DEMOS.length / 2);
//   const shuffledDemos = [...DEMOS].sort(() => 0.5 - Math.random());
...
//       // Local image format
//       return (
//         <a href={demo.link || '#'} target="_blank" rel="noreferrer noopener">
//           <img src={demo.src} alt={demo.name} />
//         </a>
//       );
//     } else if (demo.id) {
//       // CodePen format
...
//           position: fixed;
//           width: 37.5vmin; /* Increased from 30vmin (maintains aspect ratio) */
...
//           left: 50%;
//           transform: translate(-50%, -50%);
//           /* Add sketch-like effect to images */
