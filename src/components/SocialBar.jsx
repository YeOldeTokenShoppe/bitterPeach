...
const SocialBar = ({ is80sMode = false }) => {
  ...
  return (
    <Box position="relative">
      ...
      <IconButton
          position="fixed"
          top={isMobile ? "13rem" : "13.5rem"}
          right={isMobile ? "20px" : "2rem"}
          zIndex="1100"
          aria-label="Social Media"
          icon={
            <svg width={isMobile ? "30" : "2.5rem"} height={isMobile ? "30" : "2.5rem"} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        {socialLinks.map((social, index) => {
          ...
          const offset = (index + 1) * 50; // Spacing between icons
          ...
          return (
            <IconButton
              ...
              position="fixed"
              top={isMobile ? "13rem" : "13.5rem"}
              right={isMobile ? `calc(20px + ${offset}px)` : `calc(2rem + ${offset}px)`}
              size="sm"
              variant="ghost"
