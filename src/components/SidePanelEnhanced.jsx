    ...
    <>
      ...
      {isTouchDevice && !isTextBoxVisible && (
        <Button
          ...
          background="radial-gradient(ellipse at 30% 20%, rgba(255,0,255,0.9) 0px, rgba(128,0,128,0.4) 100px)"
          backdropFilter="blur(20px) contrast(1.1)"
          borderRadius="20px 0 0 20px"
          border="2px solid"
          borderRight="none"
          borderImage="linear-gradient(25deg, #726653, #C1B9A0, #8B8575, #C6BD9E, #6C6344)"
          borderImageSlice="2"
          _hover={{
            transform: "translateY(-50%) translateX(-4px)",
            boxShadow: "-4px 0 30px rgba(255,0,255,0.6)",
            "&::after": {
              opacity: "0.8"
            }
          }}
      ...
      {/* Main Panel with enhanced card-style aesthetics */}
      <Box
        ref={panelRef}
        position="fixed"
        top="0"
        ...
        _before={{
          ...
          right: 0,
          bottom: 0,
          background: "linear-gradient(to bottom right, #300A43, #493573, #B265C5, #310538)",
          opacity: 0.95,
          zIndex: -2
        }}
        _after={{
          ...
          right: 0,
          bottom: 0,
          backgroundImage: "radial-gradient(circle at 50% 50%, rgba(17,88,224,0.3), rgba(17,88,224,0.3))",
      ...
      >
        ...
        {/* <Box
          ...
          inset="0"
          border="8px solid"
          borderImage="linear-gradient(45deg, rgb(240,207,53), rgb(6,24,123), rgb(240,207,53))"
          borderImageSlice="1"
        ...
        <Box
          position="absolute"
          inset="20px"
          className="aqueous-bg"
          backgroundImage={`
            radial-gradient(circle at 10px 10px, #00f 0px, #006 30px, transparent 30px),
          ...
          filter="blur(5px) contrast(100) blur(8px) opacity(0.2)"
          pointerEvents="none"
          zIndex={0}
        />
      ...
      <style jsx global>{`
        ...
        .enhanced-panel::-webkit-scrollbar {
          width: 10px;
          background: rgba(0,0,0,0.3);
        }
        
        .enhanced-panel::-webkit-scrollbar-track {
          background: linear-gradient(180deg, rgba(110,105,75,0.3), rgba(137,122,115,0.3));
          border-radius: 5px;
        }
        
        .enhanced-panel::-webkit-scrollbar-thumb {
          background: linear-gradient(180deg, rgb(240,207,53), rgb(6,24,123));
          border-radius: 5px;
          border: 1px solid rgba(255,255,255,0.2);
        }
        
        .enhanced-panel::-webkit-scrollbar-thumb:hover {
          background: linear-gradient(180deg, rgb(255,220,60), rgb(10,30,150));
          box-shadow: 0 0 10px rgba(240,207,53,0.5);
        }
        
        /* Windy blur effects for 80s mode */
        .eighties-mode .enhanced-panel::before {
          content: '♬';
          position: absolute;
          font-size: 20rem;
          color: white;
          ...
          animation: windyRotate 20s linear infinite;
        }
        
        @keyframes windyRotate {
          from { transform: scaleY(2) scaleX(2.5) rotateZ(219deg); }
          to { transform: scaleY(2) scaleX(2.5) rotateZ(579deg); }
        }
        ...
        /* Holographic shimmer for buttons */
        .enhanced-panel button {
          position: relative;
          overflow: hidden;
        }
        
        .enhanced-panel button::after {
          content: '';
          position: absolute;
          top: -50%;
          left: -50%;
        ...
        .enhanced-panel button:hover::after {
          transform: rotate(45deg) translate(100%, 100%);
        }
      `}</style>
    </>
