...
exports.proxy = functions.https.onRequest(proxyApp);
// Create a separate app for the Fear and Greed Index function
const fearAndGreedApp = (0, express_1.default)();
fearAndGreedApp.use((0, cors_1.default)({ origin: true }));
// Fear and Greed Index endpoint
fearAndGreedApp.get('/', async (req, res) => {
    var _a;
    try {
        // Get the API key from environment variables
        const apiKey = (_a = functions.config().coinmarketcap) === null || _a === void 0 ? void 0 : _a.api_key;
        if (!apiKey) {
        ...
        const response = await axios_1.default.get('https://pro-api.coinmarketcap.com/v3/fear-and-greed/latest', {
            headers: {
...
exports.getFearAndGreed = functions.https.onRequest(fearAndGreedApp);
// Create a separate app for Alpha Vantage data
const alphaVantageApp = (0, express_1.default)();
alphaVantageApp.use((0, cors_1.default)({ origin: true }));
// Also create a separate app for Financial Modeling Prep (FMP) data
const fmpApp = (0, express_1.default)();
fmpApp.use((0, cors_1.default)({ origin: true }));
// FMP endpoint for Dollar Index
fmpApp.get('/:symbol', async (req, res) => {
    try {
...
exports.getFMPData = functions.https.onRequest(fmpApp);
// Create a separate app for Oil data that doesn't require an API key
const oilApp = (0, express_1.default)();
oilApp.use((0, cors_1.default)({ origin: true }));
// Oil data endpoint - always returns mock data
oilApp.get('/', async (req, res) => {
    try {
...
exports.getOilData = functions.https.onRequest(oilApp);
// Alpha Vantage endpoint for market data (oil and dollar)
alphaVantageApp.get('/:symbol', async (req, res) => {
    var _a;
    try {
        ...
        // Get the API key from environment variables
        const apiKey = (_a = functions.config().alphavantage) === null || _a === void 0 ? void 0 : _a.api_key;
        if (!apiKey) {
